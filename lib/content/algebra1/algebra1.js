...
import { randomQuadratic, randomSymbol, buildLinearExpressionFromValue } from "../builders";
import {
  randomIntInRange,
  gcd,
  replaceAll,
...
export default [
  ...
  // },
  {
    ...
    generate: () => {
      ...
      rhs = nerdamer.convertFromLaTeX(`\\frac{${buildLinearExpressionFromValue(symbol, solution, rhsVal / v2)}}{${v1}}`);
      ({ lhs, rhs } = randomize(lhs, rhs));
