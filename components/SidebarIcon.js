  ...
  return (
    <Link href={href}>
      <div className="relative group cursor-pointer">
        ...
        <div className="hidden lg:block absolute top-1/2 left-14 px-3 py-1 rounded drop-shadow-md bg-white dark:bg-darkDoubleElevated text-text dark:text-darkText text-lg -translate-y-1/2  opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-100 ">
          {hoverText}
