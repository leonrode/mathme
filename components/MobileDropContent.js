  ...
  return (
    <>
      <div
        ...
        } mobile-dropdown top-16 left-0 bg-white dark:bg-darkBg border-b-2 border-y-divider dark:border-y-darkDivider  w-screen absolute border-t-2 origin-top  p-4 transition-all`}
        ref={_ref}
      >
        ...
        <h3 className="text-primary dark:text-darkPrimary font-bold ">
          Upgrade
        </h3>
      ...
      <div
        className={`${
          show ? "block" : "hidden"
        } h-screen w-screen bg-transparent z-0`}
      ></div>
    </>
  );
}
