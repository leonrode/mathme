...
function CreateSearchResult({ topic, addHandler }) {
  return (
    <div className="relative -z-50 w-full bg-white dark:bg-darkElevated rounded-xl flex items-center px-2 py-3 md:px-8 mb-4 border-2 border-transparent hover:border-primary dark:hover:border-darkPrimary transition">
